...
void Embperl__Req_new_init (pTHX_ Embperl__Req  obj, SV * item, int overwrite) {
    ...
    if (SvTYPE(item) == SVt_PVMG) 
        ...
        if ((tmpsv = hv_fetch((HV *)item, "apache_req", sizeof("apache_req") - 1, 0)) || overwrite)
            obj -> pApacheReqSV = (SV *)SvREFCNT_inc(((SV *)epxs_sv2_SVPTR((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        ...
        if ((tmpsv = hv_fetch((HV *)item, "session_id", sizeof("session_id") - 1, 0)) || overwrite)
            obj -> sSessionID = (char *)ep_pstrdup(obj->pPool,((char *)epxs_sv2_PV((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        if ((tmpsv = hv_fetch((HV *)item, "session_user_id", sizeof("session_user_id") - 1, 0)) || overwrite)
            obj -> sSessionUserID = (char *)ep_pstrdup(obj->pPool,((char *)epxs_sv2_PV((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        if ((tmpsv = hv_fetch((HV *)item, "session_state_id", sizeof("session_state_id") - 1, 0)) || overwrite)
            obj -> sSessionStateID = (char *)ep_pstrdup(obj->pPool,((char *)epxs_sv2_PV((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        ...
        if ((tmpsv = hv_fetch((HV *)item, "cleanup_vars", sizeof("cleanup_vars") - 1, 0)) || overwrite)
            obj -> pCleanupAV = (AV *)SvREFCNT_inc(((AV *)epxs_sv2_AVREF((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        if ((tmpsv = hv_fetch((HV *)item, "cleanup_packages", sizeof("cleanup_packages") - 1, 0)) || overwrite)
            obj -> pCleanupPackagesHV = (HV *)SvREFCNT_inc(((HV *)epxs_sv2_HVREF((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        if ((tmpsv = hv_fetch((HV *)item, "initial_cwd", sizeof("initial_cwd") - 1, 0)) || overwrite)
            obj -> sInitialCWD = (char *)ep_pstrdup(obj->pPool,((char *)epxs_sv2_PV((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        if ((tmpsv = hv_fetch((HV *)item, "messages", sizeof("messages") - 1, 0)) || overwrite)
            obj -> pMessages = (AV *)SvREFCNT_inc(((AV *)epxs_sv2_AVREF((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        if ((tmpsv = hv_fetch((HV *)item, "default_messages", sizeof("default_messages") - 1, 0)) || overwrite)
            obj -> pDefaultMessages = (AV *)SvREFCNT_inc(((AV *)epxs_sv2_AVREF((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
...
CODE:
    ...
    if (initializer) {
        ...
        if (SvTYPE(tmpsv) == SVt_PVHV || SvTYPE(tmpsv) == SVt_PVMG)  
            Embperl__Req_new_init (aTHX_ cobj, tmpsv, 1) ;
