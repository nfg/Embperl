...
void Embperl__Component__Param_new_init (pTHX_ Embperl__Component__Param  obj, SV * item, int overwrite) {
    ...
    if (SvTYPE(item) == SVt_PVMG) 
        ...
        if ((tmpsv = hv_fetch((HV *)item, "inputfile", sizeof("inputfile") - 1, 0)) || overwrite)
            obj -> sInputfile = (char *)ep_pstrdup(obj->pPool,((char *)epxs_sv2_PV((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        if ((tmpsv = hv_fetch((HV *)item, "outputfile", sizeof("outputfile") - 1, 0)) || overwrite)
            obj -> sOutputfile = (char *)ep_pstrdup(obj->pPool,((char *)epxs_sv2_PV((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        if ((tmpsv = hv_fetch((HV *)item, "input", sizeof("input") - 1, 0)) || overwrite)
            obj -> pInput = (SV *)SvREFCNT_inc(((SV *)epxs_sv2_SVPTR((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        if ((tmpsv = hv_fetch((HV *)item, "output", sizeof("output") - 1, 0)) || overwrite)
            obj -> pOutput = (SV *)SvREFCNT_inc(((SV *)epxs_sv2_SVPTR((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        if ((tmpsv = hv_fetch((HV *)item, "sub", sizeof("sub") - 1, 0)) || overwrite)
            obj -> sSub = (char *)ep_pstrdup(obj->pPool,((char *)epxs_sv2_PV((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        ...
        if ((tmpsv = hv_fetch((HV *)item, "object", sizeof("object") - 1, 0)) || overwrite)
            obj -> sObject = (char *)ep_pstrdup(obj->pPool,((char *)epxs_sv2_PV((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        if ((tmpsv = hv_fetch((HV *)item, "isa", sizeof("isa") - 1, 0)) || overwrite)
            obj -> sISA = (char *)ep_pstrdup(obj->pPool,((char *)epxs_sv2_PV((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        if ((tmpsv = hv_fetch((HV *)item, "errors", sizeof("errors") - 1, 0)) || overwrite)
            obj -> pErrArray = (AV *)SvREFCNT_inc(((AV *)epxs_sv2_AVREF((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        ...
        if ((tmpsv = hv_fetch((HV *)item, "param", sizeof("param") - 1, 0)) || overwrite)
            obj -> pParam = (AV *)SvREFCNT_inc(((AV *)epxs_sv2_AVREF((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        if ((tmpsv = hv_fetch((HV *)item, "fdat", sizeof("fdat") - 1, 0)) || overwrite)
            obj -> pFormHash = (HV *)SvREFCNT_inc(((HV *)epxs_sv2_HVREF((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        if ((tmpsv = hv_fetch((HV *)item, "ffld", sizeof("ffld") - 1, 0)) || overwrite)
            obj -> pFormArray = (AV *)SvREFCNT_inc(((AV *)epxs_sv2_AVREF((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        if ((tmpsv = hv_fetch((HV *)item, "xsltparam", sizeof("xsltparam") - 1, 0)) || overwrite)
            obj -> pXsltParam = (HV *)SvREFCNT_inc(((HV *)epxs_sv2_HVREF((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
   ; }
...
CODE:
    ...
    if (initializer) {
        ...
        if (SvTYPE(tmpsv) == SVt_PVHV || SvTYPE(tmpsv) == SVt_PVMG)  
            Embperl__Component__Param_new_init (aTHX_ cobj, tmpsv, 1) ;
