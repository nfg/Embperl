...
void Embperl__Component_new_init (pTHX_ Embperl__Component  obj, SV * item, int overwrite) {
    ...
    if (SvTYPE(item) == SVt_PVMG) 
        ...
        if ((tmpsv = hv_fetch((HV *)item, "exit", sizeof("exit") - 1, 0)) || overwrite)
        ...
        if ((tmpsv = hv_fetch((HV *)item, "cwd", sizeof("cwd") - 1, 0)) || overwrite)
            obj -> sCWD = (char *)ep_pstrdup(obj->pPool,((char *)epxs_sv2_PV((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        ...
        if ((tmpsv = hv_fetch((HV *)item, "sourcefile", sizeof("sourcefile") - 1, 0)) || overwrite)
            obj -> sSourcefile = (char *)ep_pstrdup(obj->pPool,((char *)epxs_sv2_PV((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        if ((tmpsv = hv_fetch((HV *)item, "buf", sizeof("buf") - 1, 0)) || overwrite)
            obj -> pBuf = (char *)ep_pstrdup(obj->pPool,((char *)epxs_sv2_PV((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        if ((tmpsv = hv_fetch((HV *)item, "end_pos", sizeof("end_pos") - 1, 0)) || overwrite)
            obj -> pEndPos = (char *)ep_pstrdup(obj->pPool,((char *)epxs_sv2_PV((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        if ((tmpsv = hv_fetch((HV *)item, "curr_pos", sizeof("curr_pos") - 1, 0)) || overwrite)
            obj -> pCurrPos = (char *)ep_pstrdup(obj->pPool,((char *)epxs_sv2_PV((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        ...
        if ((tmpsv = hv_fetch((HV *)item, "sourceline_pos", sizeof("sourceline_pos") - 1, 0)) || overwrite)
            obj -> pSourcelinePos = (char *)ep_pstrdup(obj->pPool,((char *)epxs_sv2_PV((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        if ((tmpsv = hv_fetch((HV *)item, "line_no_curr_pos", sizeof("line_no_curr_pos") - 1, 0)) || overwrite)
            obj -> pLineNoCurrPos = (char *)ep_pstrdup(obj->pPool,((char *)epxs_sv2_PV((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        ...
        if ((tmpsv = hv_fetch((HV *)item, "ifdobj", sizeof("ifdobj") - 1, 0)) || overwrite)
            obj -> ifdobj = (SV *)SvREFCNT_inc(((SV *)epxs_sv2_SVPTR((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        ...
        if ((tmpsv = hv_fetch((HV *)item, "import_stash", sizeof("import_stash") - 1, 0)) || overwrite)
            obj -> pImportStash = (HV *)SvREFCNT_inc(((HV *)epxs_sv2_HVREF((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        if ((tmpsv = hv_fetch((HV *)item, "exports", sizeof("exports") - 1, 0)) || overwrite)
            obj -> pExportHash = (HV *)SvREFCNT_inc(((HV *)epxs_sv2_HVREF((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        if ((tmpsv = hv_fetch((HV *)item, "curr_package", sizeof("curr_package") - 1, 0)) || overwrite)
            obj -> sCurrPackage = (char *)ep_pstrdup(obj->pPool,((char *)epxs_sv2_PV((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        if ((tmpsv = hv_fetch((HV *)item, "eval_package", sizeof("eval_package") - 1, 0)) || overwrite)
            obj -> sEvalPackage = (char *)ep_pstrdup(obj->pPool,((char *)epxs_sv2_PV((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        if ((tmpsv = hv_fetch((HV *)item, "main_sub", sizeof("main_sub") - 1, 0)) || overwrite)
            obj -> sMainSub = (char *)ep_pstrdup(obj->pPool,((char *)epxs_sv2_PV((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        if ((tmpsv = hv_fetch((HV *)item, "prog_run", sizeof("prog_run") - 1, 0)) || overwrite)
            obj -> pProgRun = (char *)ep_pstrdup(obj->pPool,((char *)epxs_sv2_PV((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        if ((tmpsv = hv_fetch((HV *)item, "prog_def", sizeof("prog_def") - 1, 0)) || overwrite)
            obj -> pProgDef = (char *)ep_pstrdup(obj->pPool,((char *)epxs_sv2_PV((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
        if ((tmpsv = hv_fetch((HV *)item, "code", sizeof("code") - 1, 0)) || overwrite)
            obj -> pCodeSV = (SV *)SvREFCNT_inc(((SV *)epxs_sv2_SVPTR((tmpsv && *tmpsv?*tmpsv:&PL_sv_undef))));
   ; }
...
CODE:
    ...
    if (initializer) {
        ...
        if (SvTYPE(tmpsv) == SVt_PVHV || SvTYPE(tmpsv) == SVt_PVMG)  
            Embperl__Component_new_init (aTHX_ cobj, tmpsv, 1) ;
