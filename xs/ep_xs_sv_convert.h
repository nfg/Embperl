...
#define epxs_sv2_pid_t(sv) (pid_t)SvIV(sv)

#define epxs_pid_t_2obj(v) sv_2mortal(newSViv(v))
...
#define epxs_SVPTR_2obj(x) (sv_2mortal(SvREFCNT_inc(x)))

#define epxs_sv2_PV(sv) (SvOK(sv)?SvPV(sv, PL_na):NULL)

#define epxs_PV_2obj(x) (x==NULL?&PL_sv_undef:sv_2mortal(newSVpv(x, 0)))
