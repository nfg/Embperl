...
$component -> curr_pos I<[read only]>
...
$component -> sourceline I<[read only]>
...
=head2 sourceline_pos

=over

=item Method:

$component -> sourceline_pos I<[read only]>
...
=head2 line_no_curr_pos

=over

=item Method:

$component -> line_no_curr_pos I<[read only]>
...
$component -> document I<[read only]>
...
$component -> curr_node I<[read only]>
...
=head2 curr_repeat_level

=over

=item Method:

$component -> curr_repeat_level I<[read only]>
...
=head2 curr_checkpoint

=over

=item Method:

$component -> curr_checkpoint I<[read only]>
...
$component -> curr_dom_tree I<[read only]>
...
=head2 source_dom_tree

=over

=item Method:

$component -> source_dom_tree I<[read only]>
...
=head2 append_to_main_req

=over

=item Method:

$component -> append_to_main_req I<[read only]>
...
$component -> eval_package I<[read only]>
...
$component -> main_sub I<[read only]>
...
$component -> prog_run I<[read only]>
...
$component -> prog_def I<[read only]>
